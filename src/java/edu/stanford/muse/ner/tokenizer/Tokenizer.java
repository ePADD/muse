 ...
 * @TODO: Tokenizer is not handling names that start with '>' well for ex: ">Holly Crumpton" will emit Holly and Crumpton as two tokens
...
public class Tokenizer {
	...
	public static Set<String> getNamesFromPatternWithoutOffset(String content, boolean pn) {
		List<Triple<String, Integer, Integer>> offsets = getNamesFromPattern(content, pn);
    ...
    public static String[] tokeniseQuoteS(String name){
	...
	public static List<Triple<String, Integer, Integer>> getNamesFromPattern(String content, boolean pn) {
		...
		for (Span sentenceSpan : sentenceSpans) {
            ...
            //Is there an easy way to test with the sentence is good or bad quickly and easy way to tokenise it further if it is good?
            if(sent.length()>=2000)
                continue;
...
//						NER.log.warn("Serious warning: offsets not proper for: "+name);
	...
	public static void main(String[] args) {
		System.err.println(Tokenizer.personNamePattern.pattern());
        Set<String> names = Tokenizer.getNamesFromPatternWithoutOffset("Hello, I am Vihari, Piratla'. Some thing IIT Mandi, I went to college in UCB, GH then joined NASA after a brief tenure at CERN", true);
