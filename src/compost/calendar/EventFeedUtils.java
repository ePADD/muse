...
package edu.stanford.muse.iris.calendar;
...
public class EventFeedUtils {
  ...
  public static CalendarEventEntry createIrisEvent(CalendarService service,
	      String eventTitle, String eventContent,Date date) throws ServiceException, IOException {
	  
	  	boolean isQuickAdd=false;
	  	WebContent wc=null;
	  	String recurData=null;
	    CalendarEventEntry myEntry = new CalendarEventEntry();
  ...
  private static void usage() {
    System.out.println("Syntax: EventFeedUtils <username> <password>");
