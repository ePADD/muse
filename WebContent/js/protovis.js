...
/*
pv.Dom.Node.prototype.ak_toggle = function(recursive) {
  if (recursive) return this.ak_toggled
      ? this.visitBefore(function(n) { if (n.ak_toggled) n.ak_toggle(); })
      : this.visitAfter(function(n) { if (!n.ak_toggled) n.ak_toggle(); });
  var n = this;
  if (n.ak_toggled) {
    for (var c; c = n.ak_toggled.pop();) n.appendChild(c);
    delete n.ak_toggled;
  } else if (n.lastChild) {
    n.toggled = [];
    while (n.lastChild) n.toggled.push(n.removeChild(n.lastChild));
