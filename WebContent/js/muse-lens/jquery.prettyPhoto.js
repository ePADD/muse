...
(function($) {
	...
	// sgh: this is a patched version of pretty photo that fixes a bug -- it was using jQuery in several places instead of $.
	// the script should only use $ since jQuery may be reassigned (and is made invisible by the lens JS)
...
console.log ('pphoto matched objects = ' + matchedObjects.length);
...
console.log('end of pretty photo open');
			return false;
		};
