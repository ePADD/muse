<%@page language="java" contentType="text/javascript; charset=UTF-8"%>
        ...
        <%@page language="java" import="edu.stanford.muse.index.GroupAssigner"%>
        <%@page language="java" import="edu.stanford.muse.memory.MemoryStudy"%>
        <%@page language="java" import="edu.stanford.muse.memory.Screener"%><%@ page import="edu.stanford.muse.util.EmailUtils"%><%@ page import="edu.stanford.muse.util.Pair"%><%@ page import="edu.stanford.muse.util.Util"%><%@ page import="edu.stanford.muse.webapp.JSPHelper"%><%@ page import="edu.stanford.muse.webapp.SimpleSessions"%><%@ page import="org.json.JSONObject"%><%@ page import="java.util.Collection"%><%@ page import="java.util.List"%>
        <%
            ...
            try {
                ...
                // step 1: fetch
                Collection<EmailDocument> emailDocs;
                ...
                if (emailDocs == null) {
                    ...
                    if (searchMode) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                JSPHelper.log.info("Error clearing carche");
                    ...
                    if (archive.addressBook != null) { // can be null when doing screening for meorystudy
                    ...
                    Pair<String, String> p = Util.fieldsToCSV(archive.getStats(), false);
