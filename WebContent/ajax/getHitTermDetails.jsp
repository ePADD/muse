...
<%@page language="java" import="org.json.JSONObject"%><%@ page import="java.util.ArrayList"%><%@ page import="java.util.List"%>
        <%
        ...
        try {
            ...
            try { pageScore = Float.parseFloat(pageScoreStr); } catch (Exception e) { Util.print_exception(e, JSPHelper.log);}
