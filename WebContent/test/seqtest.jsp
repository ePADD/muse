...
//        out.println(p.getFirst()+" : "+p.getSecond()+"<br>");
    ...
    for(short type: types) {
        ...
        Map<String, Set<String>> features = nerModel.dictionary.generateFeatures(phrase, type);
